...
knitr::opts_chunk$set(echo = FALSE, warning=FALSE, message=FALSE, fig.height = 3, size = 1)
...
setwd("C:/Users/meglarse/GitHub/eco-evo-stoich/supporting-files/")

# Load dependancies
require(plotrix);require(pander); require(igraph)
...
#tiff(filename = "./pub-figures/Fig1-PercChange.tiff",
#     width = 570, height = 570, units = "px", pointsize = 11,
#     bg = "white", res = 100)

par(mar = c(6,5,2,1) + 0.1, mfrow = c(1,1))
plot(perc.means[,3] ~ perc.means[,4], 
     xaxt = 'n', las = 1,
...
```{r avgpops-v1-pdf,results = 'hide', fig.height=3, fig.width=6.5, echo=FALSE, fig.cap="Treatment Chemostats"}
day.start <- -6
day.end <- 170
...
#tiff(filename = "./pub-figures/Fig2-AvgPopDynamics.tiff",
...
points(avg$day[avg$day >= day.start],avg$NmeanSI[avg$day >= day.start],
      ...
      type = 'o',lwd = 1.75,cex = 1.75, lty = 1)
points(avg$day,avg$NmeanP,
      pch = 22, col = "black",bg = "black",
      type = 'l',lwd = 1.75,cex = 1.75 , lty = 1)
points(avg$day,avg$NmeanP,
      pch = 22, col = "white",bg = "black",
      type = 'p',lwd = 1.75,cex = 1.75 , lty = 1)
...
legend("bottomright", c("SRIM8 phage","Synechococcus"),
...
```{r avgpops-v1-png,results = 'hide', fig.height=3.75, fig.width=6.5, echo=FALSE, fig.cap="Treatment Chemostats", eval = FALSE}
day.start <- -6
day.end <- 170
...
**Figure 3** Coevolutionary strength of interactions
```{r coevo-pdf,echo=FALSE,fig.height=3,fig.width=6.5,results='hide'}
...
#tiff(filename = "./pub-figures/Fig3-CoEvoDynamics.tiff",
#     width = 1140, height = 570, units = "px", pointsize = 13,
#     bg = "white", res = 100)
...
**Figure S3** Infection matrices

\newpage

**Figure S4** Average *Synechococcus* resistance and phage host range
```{r average HR and resistance, fig.height = 3}
